...
function TrustStrip() {
  ...
  return (
    <div className="border-y border-white/[0.06] bg-pr-bg2 overflow-hidden py-4" aria-label="Platform info">
...
function StatsSection() {
  const stats = [
    {
      n: '50K+', label: 'Lines of Code', icon: (
    ...
    {
      n: '9', label: 'Ecosystem Divisions', icon: (
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    ...
    {
      n: '12+', label: 'Planned Products', icon: (
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    ...
    {
      n: '5yr', label: 'Long-term Vision', icon: (
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {stats.map((s, i) => (
            ...
            >
              ...
              <div className="text-xs text-pr-text3 font-mono uppercase tracking-wider">{s.label}</div>
            </motion.div>
          ))}
        </div>
      </div>
...
function CTABanner() {
  return (
    <section className="py-24 relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-br from-cyan/[0.05] via-transparent to-violet/[0.05]" aria-hidden="true" />
      <div className="absolute inset-0 bg-grid opacity-30 pointer-events-none" aria-hidden="true" />
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[300px] rounded-full blur-[120px] opacity-[0.06] bg-cyan pointer-events-none" aria-hidden="true" />
      ...
      <div className="container relative z-10 text-center">
        ...
        >
          ...
          <h2 className="font-display font-black text-4xl md:text-6xl mb-6 leading-tight text-pr-text">
            Ready to{' '}
            <span className="bg-gradient-to-r from-cyan to-violet bg-clip-text text-transparent">build</span>
            ?
          </h2>

          <p className="text-lg text-pr-text2 max-w-xl mx-auto mb-10 leading-relaxed">
            Follow the journey as Pixel Raider grows from a brand into a full technology ecosystem — one phase at a time.
          </p>
...
function ContactStrip() {
  return (
    <section id="contact" className="section border-t border-white/[0.06]" style={{ background: 'var(--bg2)' }}>
